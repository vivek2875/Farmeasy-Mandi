...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Local Farming Marketplace</title>
	...
	<body>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Local Farming Marketplace Office<span>India</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:FarmEasy@gmail.com" style="color:white">Farming@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Local Farming</b></span>
